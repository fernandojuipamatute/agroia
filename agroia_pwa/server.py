...
def recibir_pesada():
    ...
    # Guardar en memoria compartida para que la app HTML pueda consultarla
    ahora = datetime.now()
    ...
    pesada_para_app = {
        ...
        "origen": data.get("origen", "simulacion")
    }
...
def pesadas_recientes():
    ...
    Usado por la app HTML para hacer polling y mostrar pesadas
    enviadas por el script de simulacion en tiempo real."""
